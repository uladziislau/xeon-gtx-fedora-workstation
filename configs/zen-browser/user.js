...
// -----------------------------------------------------------------------------
user_pref("layout.css.devPixelsPerPx", "1.25"); // Отключено, используем системный DPI
...
user_pref("gfx.canvas.accelerated.cache-size", 1024);  // 1GB видеопамяти под Canvas
...
// -----------------------------------------------------------------------------
user_pref("dom.ipc.processCount", 32);                 // 32 процесса
